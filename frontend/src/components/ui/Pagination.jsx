    ...
    <div className="flex items-center justify-between pt-2 border-t border-slate-700/20">
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          className="h-7 w-7 flex items-center justify-center rounded-lg border border-slate-700/25 text-slate-400 hover:text-slate-200 hover:border-slate-600 disabled:opacity-30 disabled:cursor-not-allowed transition-all"
        >
              ...
              <button
                ...
                className={`h-7 w-7 flex items-center justify-center rounded-lg text-[10px] font-bold border transition-all ${
                  currentPage === p
                    ...
                    : "border-slate-700/25 text-slate-400 hover:text-slate-200 hover:border-slate-600"
                }`}
              >
                {p}
              </button>
