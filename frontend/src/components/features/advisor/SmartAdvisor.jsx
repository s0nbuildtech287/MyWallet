...
export default function SmartAdvisor({
  ...
  return (
    <div className="bg-gradient-to-br from-slate-900/60 to-slate-950/80 border border-slate-850 rounded-2xl p-5 shadow-2xl backdrop-blur-lg flex flex-col gap-4 animate-fadeIn">
      {/* Header */}
      ...
      {/* Main Analysis Text */}
      <p className="text-xs text-slate-300 leading-relaxed bg-slate-950/40 border border-slate-850/60 rounded-xl p-3.5 italic">
        "{finalDescription}"
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
        {/* RSI */}
        {rsi !== null && (
          <div className="bg-slate-950/30 border border-slate-850 rounded-xl p-3 flex flex-col gap-1">
